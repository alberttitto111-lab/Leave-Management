  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Buttons moved here - just below the form */}
        <View style={styles.buttonContainerInline}>
          ...
          {currentStep < 3 ? (
            <TouchableOpacity
              style={[
                styles.nextButtonInline, 
                currentStep === 1 && styles.fullWidthInline
              ]}
              onPress={() => {
            ...
            <TouchableOpacity
              style={[styles.nextButtonInline, styles.submitButtonInline]}
              onPress={async () => {
                if (!submitted) {
...
const styles = StyleSheet.create({
  ...
  // New inline button styles (moved from fixed position)
